...
const ShippingDialog: React.FC<SimpleDialogProps> = (props) => {
    ...
    const telephoneValidation2 = (value: string): string => {
        ...
        const regex = /^[0-9]+$/;
        if (!regex.test(value)) return '※半角数字を入力してください'
        if (4 !== value.length) return '※4桁入力してください'
        return ''
    }
                            ...
                            <Grid container alignContent="center" justify="center" className={classes.pad}>
                                <div className={classes.root}>
                                    ...
                                    <Grid container justify={"center"} alignItems={"center"}>
                                        <Grid item xs={5}>
                                            <div style={{color: 'red', fontSize: 'small'}}>{zipcode1.errorMessage}</div>
                                            <TextField
                                                id="zipcode1"
                                                label="郵便番号( ○○○ )"
                                                size={"small"}
                                        ...
                                        <Grid item xs={6}>
                                            <div style={{color: 'red', fontSize: 'small'}}>{zipcode2.errorMessage}</div>
                                            <TextField
                                                id="zipcode2"
                                                label="郵便番号( ○○○○ )"
                                                size={"small"}
                                    ...
                                    <Grid container alignItems={"center"}>
                                        <Grid item xs={3}>
                                            <div style={{
                                                color: 'red',
                                                fontSize: 'small'
                                            }}>{firstTelephoneNum.errorMessage}</div>
                                            <TextField
                                                id="telephone1"
                                                label="電話番号"
                                                size={"small"}
                                        ...
                                        <Grid item xs={4}>
                                            <div style={{
                                                color: 'red',
                                                fontSize: 'small'
                                            }}>{secondTelephoneNum.errorMessage}</div>
                                            <TextField
                                                id="telephone2"
                                                label="電話番号"
                                                size={"small"}
                                        ...
                                        <Grid item xs={4}>
                                            <div style={{
                                                color: 'red',
                                                fontSize: 'small'
                                            }}>{thirdTelephoneNum.errorMessage}</div>
                                            <TextField
                                                id="telephone3"
                                                label="電話番号"
                                                size={"small"}
