...
const OrderForm: React.FC<Props> = (props) => {
    ...
    //mockサーバーにデータを送る
    const [executeOrder, {loading: orderLoading, error: orderError}] = useOrderMutation();
    const handleClick = async () => {
        ...
        await executeOrder({variables: {order: orderInfo}}).then(() => {
    ...
    return (orderLoading ? <LinearProgress style={{width: "60%", marginTop: "20%", marginLeft: "20%"}}/>
            :
            <div>
                    ...
                    <Grid container spacing={3} justify="center" alignItems="center">
                        ...
                        <Grid item xs={6} sm={2}>
                            <Paper className={classes.totalPricePaper}>
                                {/*合計金額表示用コンポーネント*/}
                                <TotalPrice subTotalPrice={props.totalPrice}/>
                            </Paper>
                            <br/>
                            <Button variant="contained"
                                    fullWidth
